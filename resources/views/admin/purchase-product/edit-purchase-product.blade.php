                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-control" id="godown_id" name="godown_id" disabled >
                                                                <option value="">Select One</option>                                          
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text"  class="form-control"  name="challan_no" value="{{$product_purchase->challan_no}}"  required />
                                                    </div>
                                                </div>
                                            </div>
         ...
         <hr style="border-top: 3px double #8c8b8b;">
                ...
                <div class="table-responsive" style="margin-top: 10px">
                    <table class="table table-bordered table-hover" id="purchaseTable">
                        <thead>
                             <tr>
                                 <th class="text-center" width="20%">Item code</th> 
                        ...
                        <tbody id="table">
                            ...
                            <tr>
                               ...
                               {{-- <td class="wt">
                                    ...
                                    <td class="test">
                                        <input type="text" name="product_rate[]"  id="product_rate_1" class="form-control  product_rate text-right" value="{{$purchase_details->rate}}" autocomplete="off">
                                    </td>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="discount" name="dis_percent" class="form-control text-right" value="{{$discount_per}}"  autocomplete="off"></td>
                                <td class="text-right">
