...
<br>
	...
	<div class="card">
			     <div class="card-body">
				   <div class="card-title"> <i class="fa fa-plus"></i> Update  Product CFT</div>
				   <hr>				  
			   <!-- Add Product -->
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <form action="{{route('product.cft.update')}}" method="POST">
                        @csrf
                            <div class="panel-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                      ...
                                                      <select  class="form-control select2" name="grade_id" id="" required>
                                                          ...
                                                          <option value="{{$grade->id}}" {{$productCft->grade_id == $grade->id ? 'selected' : ''}}>{{$grade->name.' '.'@'.$grade->price}}</option>
                                                          @endforeach
                                    ...
                                    <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="number" class="form-control"  name="length" value="{{$productCft->length}}"  required />
                                                        <input type="hidden"  name="id" value="{{$productCft->id}}"   />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="number" class="form-control"  name="width" value="{{$productCft->width}}"  required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="number" class="form-control"  name="height" value="{{$productCft->height}}"  required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                          ...
                                          <div class="col-sm-4">
                                        <button type="submit" class="btn btn-primary shadow-primary px-5"></i> Update Product CFT</button>
                                      </div>
