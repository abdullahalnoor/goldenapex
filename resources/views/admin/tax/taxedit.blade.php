...
@section('mainContent')
	...
	<div class="card">
			     <div class="card-body">
				   ...
				   <hr>				   
				    {!! Form::open(['url' => '/tax/update/','method'=>'POST','name'=>'editform']) !!}
				    <div class="row">
					...
					<div class="form-group row">
					  ...
					  <div class="col-sm-6">
						<input type="text" class="form-control" id="input-4" name="Taxname" value="{{ $tax->tax }}">
					  </div>
					</div>
				 ...
				 <script type="text/javascript">
				 	document.forms['editform'].elements['status'].value='{{ $tax->status }}'
				 </script>
